...
def receiveFile(request):
    ...
    inicio = lineas_por_parte
    fin = lineas_por_parte * 2
    ...
    nombre_fragmento = f"{archivo.name}_parte2.txt"
    ...
    return Response({
        "mensaje": "Nodo 2 guardó su fragmento",
        "lineas_guardadas": len(fragmento_lineas),
        "contenidoNodo2":fragmento_lineas
    })